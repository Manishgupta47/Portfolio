...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#0f0f0f] via-[#1a1a1a] to-[#111827] text-white font-poppins px-4 sm:px-8 md:px-20 py-20 relative overflow-hidden">
      ...
      <FadeInSection>
        <div className="max-w-6xl mx-auto z-10 relative">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full md:w-[60%] text-gray-300 text-[1rem] leading-7 space-y-4">
              {[
                ...
                <p key={index} className="flex items-start gap-3">
                  <FaBolt className="text-indigo-400 mt-[6px] flex-shrink-0" />
                  <span>{text}</span>
                </p>
              ))}
            </div>
